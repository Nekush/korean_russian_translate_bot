...
async def command_about_handler(message: Message) -> None:
    ...
    await message.answer("""Данный Telegram-бот создали студенты 3-го курса группы 04.3-204 Института международных отношений, истории и востоковедения Казанского (Приволжского) Федерального университета Ибрагимова Раина, Иванова Виктория, Камалова Рената, Каречникова Лия и Саитова Вероника. 
